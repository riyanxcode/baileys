...
await sock.sendMessage(jid, {
  eventMessage: {
    isCanceled: false,
    name: "Hello World",
    description: "Riyan Native",
    location: {
      degreesLatitude: 0,
      degreesLongitude: 0,
      name: "Riyan"
    },
    joinLink: "https://call.whatsapp.com/video/riyan",
    ...
    nativeFlowMessage: {
      messageParamsJson: JSON.stringify({       
        ...
        tap_target_configuration: {
          ...
          canonical_url: "https://t.me/riyanxcode",
...
await sock.sendMessage(jid, {
  interactiveMessage: {
    ...
    externalAdReply: {
      ...
      mediaUrl: " X ",
      sourceUrl: "https://t.me/riyanxcode",
    ...
    buttons: [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: "https://t.me/riyanxcode",
          merchant_url: "https://t.me/riyanxcode"
        })
      }
    ]
  }
